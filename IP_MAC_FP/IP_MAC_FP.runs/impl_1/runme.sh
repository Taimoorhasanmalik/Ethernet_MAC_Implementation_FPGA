...
HD_PWD='C:/Users/Taimoor/Desktop/SIVP Lab/IP_MAC_FP/IP_MAC_FP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_MAC_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IP_MAC_BD_wrapper.tcl -notrace
