...
HD_PWD='C:/Users/Taimoor/Desktop/SIVP Lab/IP_MAC_FP/IP_MAC_FP.runs/IP_MAC_BD_axi_serializer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_MAC_BD_axi_serializer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_MAC_BD_axi_serializer_0_0.tcl
